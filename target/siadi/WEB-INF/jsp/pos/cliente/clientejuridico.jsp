...
<html ng-app="clienteModule">
    ...
    <body class="nav-md body-red" ng-controller="clientejuridicoController" ng-cloak>
                                ...
                                <div class="x_content">
                                                        ...
                                                        <div class="panel-body">
                                                            <div class="row">
                                                                <div class="form-group col-ss-12 col-xs-3 col-sm-2">
                                                                    ...
                                                                    <input ng-model="cliente.codigo" name="codigo" class="form-control input-sm" type="text" disabled="" uppercased>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-ss-12 col-xs-3 col-sm-3">
                                                                    ...
                                                                    <input ng-model="cliente.clientejuridico.ruc" name="ruc" class="form-control input-sm" type="number">
                                                                </div>
                                                                <div class="form-group col-ss-12 col-xs-5 col-sm-5">
                                                                    <label>RAZON SOCIAL<span class="span-salmon"> (*)</span></label>
                                                                    <input ng-model="cliente.clientejuridico.razonsocial" name="razonsocial" class="form-control input-sm" type="text" uppercased>
                                                                </div>
                                                                <div class="form-group col-ss-12 col-xs-4 col-sm-4">
                                                                    <label>NOMBRE COMERCIAL</label>
                                                                    <input ng-model="cliente.clientejuridico.nombrecomercial" name="nombrecomercial" class="form-control input-sm" type="text" uppercased>
                                                                </div>
                                                                <div class="form-group col-ss-12 col-xs-3 col-sm-3">
                                                                    <label>GIRO NEGOCIO</label>
                                                                    <input ng-model="cliente.clientejuridico.jironegocio" name="jironegocio" class="form-control input-sm" type="text" uppercased>
                                                                </div>
                                                                <div class="form-group col-ss-12 col-xs-3 col-sm-3">
                                                                    <label>TELÉFONO</label>
                                                                    <input ng-model="cliente.clientejuridico.telefono" name="telefono" class="form-control input-sm" type="number">
                                                                </div>
                                                                <div class="form-group col-ss-12 col-xs-3 col-sm-3">
                                                                    <label>FECHA FUNDACIÓN</label>
                                                                    <input ng-model="cliente.clientejuridico.fechafundacion" name="fechafundacion" class="form-control input-sm">
                                                                </div>
                                                                <div class="form-group col-ss-12 col-xs-3 col-sm-3">
                                                                    <label>EMAIL</label>
                                                                    <input ng-model="cliente.clientejuridico.email" name="email" class="form-control input-sm" uppercased>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-ss-12 col-xs-8 col-sm-8">
                                                                    ...
                                                                    <input ng-model="cliente.clientejuridico.direccion" name="direccion" class="form-control input-sm" type="text" uppercased>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <form name="formulariorl" ng-submit="registrarrl(formulariorl)" ng-validate="validaterl">
                                                                <div class="form-group col-ss-12 col-xs-4 col-sm-4">
                                                                    ...
                                                                    <input ng-model="representantlegal.dni" name="dni" class="form-control input-sm" type="number">
                                                                </div>
                                                                <div class="form-group col-ss-12 col-xs-4 col-sm-4">
                                                                    <label>NOMBRE<span class="span-salmon"> (*)</span></label>
                                                                    <input ng-model="representantlegal.nombre" name="nombre" class="form-control input-sm" type="text" uppercased>
                                                                </div>
                                                                <div class="form-group col-ss-12 col-xs-4 col-sm-4">
                                                                    <label>APELLIDO PATERNO<span class="span-salmon"> (*)</span></label>
                                                                    <input ng-model="representantlegal.apellidopat" name="apellidopat" class="form-control input-sm" type="text" uppercased>
                                                                </div>
                                                                <div class="form-group col-ss-12 col-xs-4 col-sm-4">
                                                                    <label>APELLIDO MATERNO<span class="span-salmon"> (*)</span></label>
                                                                    <input ng-model="representantlegal.apellidomat" name="apellidomat" class="form-control input-sm" type="text" uppercased>
                                                                </div>
                                                                <div class="form-group col-ss-12 col-xs-4 col-sm-4">
                                                                    <label>CARGO<span class="span-salmon"> (*)</span></label>
                                                                    <input ng-model="representantlegal.cargo" name="cargo" class="form-control input-sm" type="text" uppercased>
                                                                </div>
                                                                <div class="form-group col-ss-12 col-xs-4 col-sm-4">
                                                                    <label>CELULAR</label>
                                                                    <input ng-model="representantlegal.celular" name="celular" class="form-control input-sm" type="number">
                                                                </div>
                                                                <div class="form-group col-ss-12 col-xs-4 col-sm-4">
                                                                    <label>EMAIL</label>
                                                                    <input ng-model="representantlegal.email" name="email" class="form-control input-sm" uppercased>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-ss-12 col-xs-12">
                                                                <table class="table table-striped">
                                                                    ...
                                                                    <tbody>
                                                                        <tr ng-show="representantlegals.length > 0" ng-repeat="representantlegal in representantlegals">
                                                                            <td>{{$index + 1}}</td>
                                                                            <td>{{representantlegal.nombre}}, {{representantlegal.apellidopat}} {{representantlegal.apellidomat}}</td>
                                                                            <td>{{representantlegal.dni}}</td>
                                                                            <td>{{representantlegal.cargo}}</td>
                                                                            <td>
                                                                                <a href="javascript:void(0)" ng-click="mostrarrl(representantlegal)" style="color: blue"><i class="fa fa-edit"></i>Mod.</a>
                                                                            </td>
                                                                            <td>
                                                                                <a href="javascript:void(0)" ng-click="eliminarrl(representantlegal)" style="color: red"><i class="fa fa-trash"></i>Del.</a>
                                                                            </td>
                                                                        </tr>
                                                                        <tr ng-show="representantlegals.length <= 0">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-ss-12 col-xs-12 col-sm-12">
                                            <button ng-click="registrarcj(formulariocj)" type="button" class="btn btn-primary">REGISTRAR</button>
                                        </div>
                                    </div>
                                            ...
                                            <table class="table table-striped jambo_table">
                                                ...
                                                <tbody>
                                                    <tr ng-show="clientes.length > 0" dir-paginate="cliente in clientes|itemsPerPage:15">
                                                        ...
                                                        <td>{{cliente.clientejuridico.razonsocial}}</td>
                                                        <td>{{cliente.clientejuridico.ruc}}</td>
                                                        <td>{{cliente.clientejuridico.telefono}}</td>
                                                        <td>{{cliente.clientejuridico.direccion}}</td>
                                                        <td>{{cliente.estado}}</td>
                                                        <td>
                                                            <a href="${pageContext.request.contextPath}/cliente/fichapj?type=pdf&&id={{cliente.id}}" target="_blank" style="color: blueviolet"><i class="fa fa-file-pdf-o"></i> Rpt.</a>
                                                        </td>
                                                        <td>
                                                            <a href="javascript:void(0)" ng-click="mostrarpj(cliente)" style="color: blue"><i class="fa fa-edit"></i> Mod.</a>

                                                        </td>
                                                        <td>
                                                            <a href="javascript:void(0)" ng-click="eliminarpj(cliente)" style="color: red"><i class="fa fa-trash"></i> Del.</a>
                                                        </td>
                                                    </tr>
                                                    <tr ng-show="clientees.length <= 0">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title text-center">Modificar cliente juridico <b>{{clientea.codigo}}</b></h4>
                    </div>
                    <div class="modal-body">
                        <form name="formulariopja" ng-submit="actualizarpj(formulariopja)" ng-validate="validatepj">
                            <div class="row">
                                ...
                                <div class="col-ss-12 col-xs-4">
                                    ...
                                    <select ng-options="estado as estado.nombre for estado in estados track by estado.id" ng-model="clientea.estado" name="estado" class="form-control input-sm"></select>
                                </div>
                                <div class="col-ss-12 col-xs-4">
                                    <label>Ruc <span class="span-salmon"> (*)</span></label>
                                    <input ng-model="clientea.clientejuridico.ruc" name="ruc" class="form-control input-sm" type="number">
                                </div>
                                <div class="col-ss-12 col-xs-4 ">
                                    <label>Razon social <span class="span-salmon"> (*)</span></label>
                                    <input ng-model="clientea.clientejuridico.razonsocial" name="razonsocial" class="form-control input-sm" type="text" uppercased>
                                </div>
                                <div class="col-ss-12 col-xs-4">
                                    <label>Nombre comercial <span class="span-salmon"> (*)</span></label>
                                    <input ng-model="clientea.clientejuridico.nombrecomercial" name="nombrecomercial" class="form-control input-sm" type="text" uppercased>
                                </div>
                                <div class="col-ss-12 col-xs-4">
                                    <label>Jiro de negocio <span class="span-salmon"> (*)</span></label>
                                    <input ng-model="clientea.clientejuridico.jironegocio" name="jironegocio" class="form-control input-sm" type="text" uppercased>
                                </div>
                                <div class="col-ss-12 col-xs-4">
                                    <label>Telefono <span class="span-salmon"> (*)</span></label>
                                    <input ng-model="clientea.clientejuridico.telefono" name="telefono" class="form-control input-sm" type="number">
                                </div>
                                <div class="col-ss-12 col-xs-4">
                                    <label>Fecha fundacion</label>
                                    <input ng-model="clientea.clientejuridico.fechafundacion" name="fechafundacion" class="form-control input-sm">
                                </div>
                                <div class="col-ss-12 col-xs-4">
                                    <label>Email</label>
                                    <input ng-model="clientea.clientejuridico.email" name="email" class="form-control input-sm" uppercased>
                                </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-ss-12 col-xs-8">
                                                    ...
                                                    <input ng-model="clientea.clientejuridico.direccion" name="direccion" class="form-control input-sm" type="text" uppercased>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <form name="formulariorla" ng-submit="registrarrla(formulariorla)" ng-validate="validaterl">
                            <div class="row">
                                ...
                                <div class="col-ss-12 col-xs-4">
                                    <label>Dni <span class="span-salmon"> (*)</span></label>
                                    <input ng-model="representantlegala.dni" name="dni" class="form-control input-sm" type="number">
                                </div>
                                <div class="col-ss-12 col-xs-4">
                                    <label>Nombre <span class="span-salmon"> (*)</span></label>
                                    <input ng-model="representantlegala.nombre" name="nombre" class="form-control input-sm" type="text" uppercased>
                                </div>
                                <div class="col-ss-12 col-xs-4">
                                    <label>Apellido paterno <span class="span-salmon"> (*)</span></label>
                                    <input ng-model="representantlegala.apellidopat" name="apellidopat" class="form-control input-sm" type="text" uppercased>
                                </div>
                                <div class="col-ss-12 col-xs-4">
                                    <label>Apellido materno <span class="span-salmon"> (*)</span></label>
                                    <input ng-model="representantlegala.apellidomat" name="apellidomat" class="form-control input-sm" type="text" uppercased>
                                </div>
                                <div class="col-ss-12 col-xs-4">
                                    <label>Cargo <span class="span-salmon"> (*)</span></label>
                                    <input ng-model="representantlegala.cargo" name="cargo" class="form-control input-sm" type="text" uppercased>
                                </div>
                                <div class="col-ss-12 col-xs-4">
                                    <label>Celular</label>
                                    <input ng-model="representantlegala.celular" name="celular" class="form-control input-sm" type="number">
                                </div>
                                <div class="col-ss-12 col-xs-4">
                                    <label>Email</label>
                                    <input ng-model="representantlegala.email" name="email" class="form-control input-sm" uppercased>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-ss-12 col-xs-12">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr ng-show="representantlegalsa.length > 0" ng-repeat="representantlegal in representantlegalsa">
                                            <td>{{representantlegal.id}}</td>
                                            <td>{{representantlegal.nombre}} {{representantlegal.apellidopat}} {{representantlegal.apellidomat}}</td>
                                            <td>{{representantlegal.dni}}</td>
                                            <td>{{representantlegal.cargo}}</td>
                                            <td>
                                                <a href="javascript:void(0)" ng-click="eliminarrla(representantlegal)" style="color: red"><i class="fa fa-trash"></i> Del.</a>
                                            </td>
                                        </tr>
                                        <tr ng-show="representantlegalsa.length <= 0">
                                            <td colspan="5" class="dataTables_empty">No hay ningun registro de representante legal</td>
                                        </tr>
                                    </tbody>
                                </table>
        ...
        <script type="text/javascript">
                                    $("form[name=formulariocj] input[name=fechafundacion]").datepicker({dateFormat: 'yy-mm-dd'});
                                    $("form[name=formulariocja] input[name=fechafundacion]").datepicker({dateFormat: 'yy-mm-dd'});
        </script>
    </body>
</html>
