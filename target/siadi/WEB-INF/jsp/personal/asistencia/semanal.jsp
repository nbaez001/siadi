...
<html ng-app="asistenciaModule">
    ...
    <body class="nav-md" ng-controller="semanalController" ng-cloak>
                        ...
                        <div class="col-ss-12 col-xs-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-1 col-xs-offset-2 well">Hora</div>
                                        <div ng-class="{'alert-info':disDni,'alert-success':!disDni}" class="col-xs-1 well">Lunes</div>
                                        <div class="col-xs-1 well">Martes</div>
                                        <div class="col-xs-1 well">Miercoles</div>
                                        <div class="col-xs-1 well">Jueves</div>
                                        <div class="col-xs-1 well">Viernes</div>
                                        <div class="col-xs-1 well">Sabado</div>
                                        <div class="col-xs-1 well">Domingo</div>
                                    </div>
                                    <div class="row" ng-repeat="semana in semanas">
                                        <div class="col-xs-1 col-xs-offset-2 well">{{semana.hora}}</div>
                                        <div ng-class="{'alert-info':semana.lunes.turno,'':!semana.lunes.turno}" class="col-xs-1 well">
                                            <text ng-if="semana.lunes.asiste==1">
                                                ASISTIO
                                            </text>
                                            <text ng-if="semana.lunes.asiste==2">
                                                TARDE
                                            </text>
                                            <text ng-if="semana.lunes.asiste==3">
                                                FALTA
                                            </text>
                                        </div>
                                        <div ng-class="{'alert-info':semana.martes.turno,'':!semana.martes.turno}" class="col-xs-1 well">
                                            <text ng-if="semana.martes.asiste==1">
                                                ASISTIO
                                            </text>
                                            <text ng-if="semana.martes.asiste==2">
                                                TARDE
                                            </text>
                                            <text ng-if="semana.martes.asiste==3">
                                                FALTA
                                            </text>
                                        </div>
                                        <div ng-class="{'alert-info':semana.miercoles.turno,'':!semana.miercoles.turno}" class="col-xs-1 well">
                                            <text ng-if="semana.miercoles.asiste==1">
                                                ASISTIO
                                            </text>
                                            <text ng-if="semana.miercoles.asiste==2">
                                                TARDE
                                            </text>
                                            <text ng-if="semana.miercoles.asiste==3">
                                                FALTA
                                            </text>
                                        </div>
                                        <div ng-class="{'alert-info':semana.jueves.turno,'':!semana.jueves.turno}" class="col-xs-1 well">
                                            <text ng-if="semana.jueves.asiste==1">
                                                ASISTIO
                                            </text>
                                            <text ng-if="semana.jueves.asiste==2">
                                                TARDE
                                            </text>
                                            <text ng-if="semana.jueves.asiste==3">
                                                FALTA
                                            </text>
                                        </div>
                                        <div ng-class="{'alert-info':semana.viernes.turno,'':!semana.viernes.turno}" class="col-xs-1 well">
                                            <text ng-if="semana.viernes.asiste==1">
                                                ASISTIO
                                            </text>
                                            <text ng-if="semana.viernes.asiste==2">
                                                TARDE
                                            </text>
                                            <text ng-if="semana.viernes.asiste==3">
                                                FALTA
                                            </text>
                                        </div>
                                        <div ng-class="{'alert-info':semana.sabado.turno,'':!semana.sabado.turno}" class="col-xs-1 well">
                                            <text ng-if="semana.sabado.asiste==1">
                                                ASISTIO
                                            </text>
                                            <text ng-if="semana.sabado.asiste==2">
                                                TARDE
                                            </text>
                                            <text ng-if="semana.sabado.asiste==3">
                                                FALTA
                                            </text>
                                        </div>
                                        <div ng-class="{'alert-info':semana.domingo.turno,'':!semana.domingo.turno}" class="col-xs-1 well">
                                            <text ng-if="semana.domingo.asiste==1">
                                                ASISTIO
                                            </text>
                                            <text ng-if="semana.domingo.asiste==2">
                                                TARDE
                                            </text>
                                            <text ng-if="semana.domingo.asiste==3">
                                                FALTA
                                            </text>
                                        </div>
                                    </div>
