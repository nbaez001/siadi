...
<html ng-app="reporteModule">
    ...
    <body class="nav-md" ng-controller="formato121Controller" ng-cloak>
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-ss-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Registro del inventario permanente en unidades fisicas</h2>
                                            ...
                                            <div class="col-ss-12 col-xs-7 col-sm-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-ss-12 col-xs-12 btn-col">
                                                        <button class="btn btn-primary" type="button" onclick="imprSelec('tablaformato121')"><i class="fa fa-print"></i> Imprimir</button>
                                                ...
                                                <table class="table table-striped jambo_table">
                                                    ...
                                                    <tbody>
                                                        <tr ng-show="movimientos.length > 0" dir-paginate="movimiento in movimientos|itemsPerPage:20" pagination-id="tm">
                                                            ...
                                                            <td>{{movimiento.saldos}}</td>
                                                        </tr>
                                                        <tr ng-show="movimientos.length <= 0">
                                                            <td colspan="8" class="dataTables_empty">No hay registros de movimientos</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <div class="col-ss-12 col-xs-12"  hidden="" id="tablaformato121">
                                                    <div class="row">
                                                        <div class="col-ss-12 col-xs-4">
                                                        ...
                                                        <div class="col-ss-12 col-xs-8" style="vertical-align: middle">
                                                            <h4>Registro del inventario permanente en unidades fisicas <small>FORMATO 12.1 SUNAT</small></h4>
