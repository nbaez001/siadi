...
(function (factory) {
    ...
    tCaption = '<div tabindex="500" class="form-control file-caption {class} input-sm">\n' +
...
//FileInput plugin definition
    ...
    $.fn.fileinputLocales.en = {
        ...
        cancelTitle: 'Abortar proceso actual',
        uploadLabel: 'Subir',
        uploadTitle: 'Subir archivos seleccionados',
        msgZoomTitle: 'Ver detalles',
        msgZoomModalHeading: 'Vista previa',
        msgSizeTooLarge: 'Archivo "{name}" (<b>{size} KB</b>) excedió el tamaño máximo permitido de <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'Debes seleccionar al menos <b>{n}</b> {files} para subir.',
        msgFilesTooMany: 'Numeros de archivos seleccionados para subir <b>({n})</b> excedió el limite máximo permitido de <b>{m}</b>.',
        msgFileNotFound: 'Archivo "{name}" no encontrado!',
        msgFileSecured: 'Hay restricciones de seguridad que no permite leer el archivo "{name}".',
        msgFileNotReadable: 'Archivo "{name}" no es legible.',
        msgFilePreviewAborted: 'La vista previa fue abortado por "{name}".',
        msgFilePreviewError: 'Ocurrio un error mientras se leia el archivo "{name}".',
        msgInvalidFileType: 'Tipo no valido para el archivo "{name}". Solo son soportados los formatos "{types}".',
        msgInvalidFileExtension: 'Extension invalida para el archivo "{name}". Solo son soportados los formatos "{extensions}".',
        msgUploadAborted: 'La carga del archivo fue interrumpida',
        msgValidationError: 'Error en la carga del archivo',
        ...
        msgFoldersNotAllowed: 'Arrastra y suelta solo archivos ! {n} los direcctorio(s) seran omitidos.',
        msgImageWidthSmall: 'El ancho de la imagen "{name}" debe ser al menos {size} px.',
        msgImageHeightSmall: 'El alto de la imagen "{name}" debe ser al menos {size} px.',
        msgImageWidthLarge: 'El ancho de la imagen "{name}" no puede exceder de {size} px.',
        msgImageHeightLarge: 'El alto de la imagen "{name}" no puede exceder de {size} px.',
        msgImageResizeError: 'No de pudo obtener las dimensiones de la imagen para redimensionar.',
        msgImageResizeException: 'Error mientras se redimensionaba la imagen.<pre>{errors}</pre>',
        dropZoneTitle: 'Arrastra y suelta archivos aqui &hellip;'
    };
