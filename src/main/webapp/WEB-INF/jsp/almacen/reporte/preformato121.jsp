...
<html ng-app="reporteModule">
    <head>
        ...
        <title>Generar formato 12.1</title>
    ...
    <body class="nav-md" ng-controller="preformato121Controller" ng-cloak>
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-ss-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Generar formato 12.1 - SUNAT</h2>
                                                ...
                                                <div class="col-ss-12 col-xs-12" style="padding-top: 25px">
                                                    <div class="row">
                                                        <div class="col-ss-12 col-xs-4">
                                                            <a href="javascript:void(0)" ng-click="generar(formulario)" class="btn btn-app" style="color: blueviolet"><i class="fa fa-file-pdf-o"></i> Generar formato 12.1</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
