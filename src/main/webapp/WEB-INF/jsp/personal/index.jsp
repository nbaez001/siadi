...
<html ng-app="homeModule">
    ...
    <body class="nav-md" ng-controller="homeController">
        ...
        <script src="${pageContext.request.contextPath}/assets/controller/personal/homeModule.js" type="text/javascript"></script>
    </body>
</html>
