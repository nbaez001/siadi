...
<div class="col-md-3 left_col">
    <div class="left_col scroll-view" tabindex="5000" style="overflow: hidden; cursor: grab;">
        <div class="navbar nav_title" style="border: 0;">
            <a href="${pageContext.request.contextPath}/modulos" class="site_title"><i class="fa icon-polar2"></i> <span>SIADI</span></a>
        </div>
